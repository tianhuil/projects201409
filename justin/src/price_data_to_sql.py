...
for filename in os.listdir('../data/dayhour'):
    ...
    taxi_data = taxi_data[['total_amount', 'tip_amount','pickup_longitude', 'pickup_latitude', 
    ...
    taxi_data['price_wo_tip'] = taxi_data['total_amount'] - taxi_data['tip_amount']
    ...
    sql_data = trip_groups_thresh['price_wo_tip'].agg(dict_of_funcs)

    # Write to sql database

    con = db.connect('taxi_price_data.db' )

    sql_data.to_sql('price_table',con, if_exists='append')
